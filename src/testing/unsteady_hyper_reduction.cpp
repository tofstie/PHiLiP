...
int UnsteadyHyperReduction<dim, nstate>::run_test() const {
    ...
    double ESROM_entropy_diff;
    double FOM_entropy_diff;
    double HROM_entropy_diff;
    ...
    // Creating FOM and Solve
    {
        ...
        FOM_entropy_diff = final_FOM_entropy - initial_FOM_entropy;
    }
    ...
    const Parameters::AllParameters Entropy_ROM_param_const = ROM_param;
    {
        ...
        ESROM_entropy_diff = final_entropy - initial_entropy;
    }
    ...
    HROM_entropy_diff = final_HROM_entropy - initial_HROM_entropy;

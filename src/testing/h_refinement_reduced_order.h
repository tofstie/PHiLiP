#ifndef __H_REFINEMENT_STUDY_REDUCED_ORDER__
#define __H_REFINEMENT_STUDY_REDUCED_ORDER__
...
class HRefinementStudyReducedOrder: public TestsBase
{
public:
    /// Constructor
    HRefinementStudyReducedOrder(
